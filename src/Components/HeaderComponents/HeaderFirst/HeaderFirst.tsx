    ...
    <Styled.HeaderNavFirstMain>
      <Styled.HeaderNavFirst>
        <Styled.ContainerFirstNav>
          <Styled.Link>Central do Vendedor</Styled.Link>
          <Styled.Link>Vender na Shopee</Styled.Link>
          <Styled.Link>Baixe o App</Styled.Link>
        ...
        <Styled.ContainerSecondNav>
          <Styled.ContainerAllSvgSecondNav>
            ...
            <Styled.Link>Notificações</Styled.Link>
          </Styled.ContainerAllSvgSecondNav>
          <Styled.ContainerAllSvgSecondNav>
          ...
          <Styled.ContainerAllSvgSecondNav>
            ...
            <Styled.Link>Português-BR</Styled.Link>
          </Styled.ContainerAllSvgSecondNav>
          <Styled.Link>{userObjState?.name}</Styled.Link>
        </Styled.ContainerSecondNav>
      </Styled.HeaderNavFirst>
    </Styled.HeaderNavFirstMain>
  );
