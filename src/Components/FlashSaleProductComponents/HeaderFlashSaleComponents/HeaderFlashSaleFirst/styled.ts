...
interface ContainerAllSvgSecondNavProps {
  $whatItIs: number;
}

export const ContainerAllSvgSecondNav = styled.div<ContainerAllSvgSecondNavProps>`
  display: flex;
  align-items: center;
  gap: 3px;
  /* margin-right: 15px; */
  margin-right: ${props => props.$whatItIs === 3 ? "15px" : "0px"};
