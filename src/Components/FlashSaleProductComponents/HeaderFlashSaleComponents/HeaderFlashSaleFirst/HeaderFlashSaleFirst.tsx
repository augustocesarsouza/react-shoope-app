    ...
    <Styled.HeaderNavFirstMain>
      <Styled.HeaderNavFirst>
        <Styled.ContainerFirstNav>
          <Styled.Link $borderRight={true}>Página inicial da Shopee</Styled.Link>
        ...
        <Styled.ContainerSecondNav>
          <Styled.ContainerAllSvgSecondNav $whatItIs={1}>
          ...
          <Styled.ContainerAllSvgSecondNav $whatItIs={2}>
          ...
          <Styled.ContainerAllSvgSecondNav $whatItIs={3}>
...
export default HeaderFlashSaleFirst;
