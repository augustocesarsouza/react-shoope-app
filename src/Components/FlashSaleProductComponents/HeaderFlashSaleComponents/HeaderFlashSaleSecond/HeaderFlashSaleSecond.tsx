...
import SvgShopeeOnlyBag from '../AllSvgHeader/SvgShopeeOnlyBag/SvgShopeeOnlyBag';
import SvgOfficialStores from '../AllSvgHeader/SvgOfficialStores/SvgOfficialStores';

const HeaderFlashSaleSecond = () => {
  ...
  return (
    <Styled.ContainerMainHeaderSecondMain>
      <Styled.ContainerMainHeaderSecond>
        ...
        <Styled.ContainerInputSearchShopeeAndCart>
...
export default HeaderFlashSaleSecond;
