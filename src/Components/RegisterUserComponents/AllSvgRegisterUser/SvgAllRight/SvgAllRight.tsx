const SvgAllRight = () => {
  return (
    <svg fill="none" viewBox="0 0 16 16" className="gUcDbg">
      <path fill="none" stroke="#6C0" d="M8 15A7 7 0 108 1a7 7 0 000 14z" clipRule="evenodd"></path>
      <path
        stroke="none"
        fill="#6C0"
        fillRule="evenodd"
